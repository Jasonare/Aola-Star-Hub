...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--id-min", type=int, default=1986, help="起始 id（含）")
    p.add_argument("--id-max", type=int, default=2020, help="结束 id（含）")
    p.add_argument("--x-min", type=int, default=0, help="起始 x（含）")
    p.add_argument("--x-max", type=int, default=10, help="结束 x（含）")
