...
ROOT = Path('.')
in_xlsx = ROOT / 'yabi_info_regenerated_from_100bt_8.xlsx'
ref_xlsx = ROOT / '原系亚比_100bt_编号_技能_种族值(8).xlsx'
out_xlsx = ROOT / 'yabi_info_regenerated_from_100bt_8_processed.xlsx'
...
# 2) map 亚比ID(编号集合值) -> dexId[] with exact name match from 页面标题
...
for ref_df in (ref_s2, ref_s3):
    for _, r in ref_df.iterrows():
        # 编号集合在第4列(0-based 3), 页面标题在第2列(0-based 1)
