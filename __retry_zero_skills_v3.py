...
OUT_XLSX = ROOT / "原系亚比_100bt_编号_技能_种族值_skill_retry_v3.xlsx"
REPORT = ROOT / "__skill_retry_report_v3.json"
...
def fetch_html(url: str) -> str:
    ...
    m = re.search("charset\s*=\s*[\"\']?\s*([a-z0-9\-_]+)", head)
    encs = []
    if m:
...
for idx in zero_df.index.tolist():
    ...
    try:
        ...
        still_zero.append({"idx": int(idx), "id": sid, "url": url, "reason": str(e)})
